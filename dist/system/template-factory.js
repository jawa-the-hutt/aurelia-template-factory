...
System.register(['aurelia-framework'], function (_export, _context) {
    ...
    var inject, noView, ViewCompiler, ViewSlot, Container, ViewResources, bindable, _typeof, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, TemplateFactory;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('TemplateFactory', TemplateFactory = (_dec = inject(ViewCompiler, ViewSlot, Container, ViewResources), noView(_class = _dec(_class = (_class2 = function () {
            ...
            _export('TemplateFactory', TemplateFactory);
        }
    };
});